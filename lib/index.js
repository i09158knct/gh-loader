(function() {
    ...
    return function(target, params, cb) {
      ...
      return request({
        ...
        if (res.statusCode !== 200) {
          return typeof cb === "function" ? cb(new Error([res.statusCode, body])) : void 0;
        }
  ...
  GitHubLoader = (function() {
    ...
    GitHubLoader.prototype._loadStarsChunk = function(pages) {
      var loadingChunk,
        _this = this;
    ...
    GitHubLoader.prototype.loadAllStars = function(cb) {
      ...
      (loopLoading = function(acc, start) {
        ...
        loading = _this._loadStarsChunk((function() {
          _results = [];
